...
- **Key parameters**: sparse_mode=topk_intermediate; s ∈ {0.5, 0.7, 0.9} set by
  ...
  survivor analysis top 10% most-frequent neurons; bf16; flash_attention_2
- **Key deps**: python 3.10, torch 2.6.0+cu124, transformers 4.46.3,
  flash-attn 2.7.4.post1
- **Model**: `/raid/LLM/llama2-7b`; output artifact
  `/home/choij/workspace/analysis/llama2_topk_overlap.pt`
